...
import StoppaProppen from "../assets/projects/stoppaproppenmob.png"
...
export const projects = [

    {
        id: 1,
        img: StoppaProppen,
        title: "Stoppa Proppen",
        desc: "Stoppa Proppen is a full-stack web application built with React and Vite on the frontend, using Zustand for state management and styled-components for styling. The backend is powered by Node.js with Express and MongoDB via Mongoose for data storage, with bcrypt handling secure password hashing and a custom access token solution for authentication. The app is deployed with the frontend on Netlify and the backend on a Node server, following a RESTful API structure.",
        tags: ["Node.js + Express"],
        netlifyUrl: "https://stoppa-proppen.netlify.app/",
        githubUrl: "https://github.com/RPaemurd/project-final" 
    },
